...
namespace VCEngine
{
    public class SolutionDescription
    {
        ...
        public static SolutionDescription Create (String path, String name)
        {
            ...
            solution.SolutionPath = Path.Combine(path, name);

            solution.ShadersPath = Path.Combine(solution.SolutionPath, DefaultShadersPath);
            solution.TexturesPath = Path.Combine(solution.SolutionPath, DefaultTexturesPath);
            solution.MaterialsPath = Path.Combine(solution.SolutionPath, DefaultMaterialsPath);
            solution.ModelsPath = Path.Combine(solution.SolutionPath, DefaultModelsPath);
