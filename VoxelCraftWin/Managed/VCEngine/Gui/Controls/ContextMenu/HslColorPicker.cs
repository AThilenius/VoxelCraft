...
namespace VCEngine
{
    public class HslColorPicker : ToolContextComponent
    {
        ...
        protected override void Draw()
        {
            ...
            Gui.Draw9SliceImage(GuiDrawer.StandardTextures.Button, new Rectangle(sf.X, sf.Y, 40, sf.Height));
            ...
            Gui.DrawRectangle(new Rectangle(sf.X + 36, sf.Y + 5, 1, sf.Height - 10), new Color(255, 255, 255, 128));
            ...
            Gui.DrawImage(GuiDrawer.StandardTextures.RoundButton, spectrumSelect);
            Gui.DrawImage(GuiDrawer.StandardTextures.RoundButton, saturationSelect);
            Gui.DrawImage(GuiDrawer.StandardTextures.RoundButton, luminocitySelect);
            Gui.DrawImage(GuiDrawer.StandardTextures.RoundButton, transparencySelector);
        }
        ...
        {
            Gui.Draw9SliceImage(GuiDrawer.StandardTextures.Button, frame);
            ...
            Gui.DrawRectangle(new Rectangle(frame.X, frame.Y, frame.Width, 1), Color.White);
        }
