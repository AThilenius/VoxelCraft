...
namespace VCEngine
{
    public class PanelsTrippleButton : Control
    {
        ...
        public PanelsTrippleButton(Window window) : base(window)
        {
            ...
            LeftButton.Image = Texture.GetInResources(@"Images\Icons\LeftPane.DDS");
            LeftButton.Width = 30;
            ...
            CenterButton.Image = Texture.GetInResources(@"Images\Icons\CenterPane.DDS");
            ...
            RightButton.Image = Texture.GetInResources(@"Images\Icons\RightPane.DDS");
