...
//  VoxelCraft
//
//  Created by Alec Thilenius on 5/19/13.
//
//
...
float raw_noise_3d( const float x, const float y, const float z ) {
    ...
    if(t0<0) n0 = 0.0;
        ...
        t0 *= t0;
        n0 = t0 * t0 * dot4(grad3[gi0], x0, y0, z0);
    }
    ...
    if(t1<0) n1 = 0.0;
        ...
        t1 *= t1;
        n1 = t1 * t1 * dot4(grad3[gi1], x1, y1, z1);
    }
    ...
    if(t2<0) n2 = 0.0;
        ...
        t2 *= t2;
        n2 = t2 * t2 * dot4(grad3[gi2], x2, y2, z2);
    }
    ...
    if(t3<0) n3 = 0.0;
        ...
        t3 *= t3;
        n3 = t3 * t3 * dot4(grad3[gi3], x3, y3, z3);
    }
...
float raw_noise_4d( const float x, const float y, const float z, const float w ) {
    ...
    if(t0<0) n0 = 0.0;
        ...
        t0 *= t0;
        n0 = t0 * t0 * dot5(grad4[gi0], x0, y0, z0, w0);
    }
    ...
    if(t1<0) n1 = 0.0;
        ...
        t1 *= t1;
        n1 = t1 * t1 * dot5(grad4[gi1], x1, y1, z1, w1);
    }
    ...
    if(t2<0) n2 = 0.0;
        ...
        t2 *= t2;
        n2 = t2 * t2 * dot5(grad4[gi2], x2, y2, z2, w2);
    }
    ...
    if(t3<0) n3 = 0.0;
        ...
        t3 *= t3;
        n3 = t3 * t3 * dot5(grad4[gi3], x3, y3, z3, w3);
    }
    ...
    if(t4<0) n4 = 0.0;
        ...
        t4 *= t4;
        n4 = t4 * t4 * dot5(grad4[gi4], x4, y4, z4, w4);
    }
...
float dot3( const int* g, const float x, const float y ) { return g[0]*x + g[1]*y; }
float dot4( const int* g, const float x, const float y, const float z ) { return g[0]*x + g[1]*y + g[2]*z; }
float dot5( const int* g, const float x, const float y, const float z, const float w ) { return g[0]*x + g[1]*y + g[2]*z + g[3]*w; }
